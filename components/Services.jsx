...
const SERVICES = [
  {
    ...
    description:
      "Quality assurance, bug identification and functionality validation — manual and automated — so you ship with confidence and zero surprises.",
  },
  {
    number: "02",
    title: "Project Management",
    description:
      "Planning, executing, monitoring and closing projects with precision — keeping scope, time and budget perfectly aligned from kickoff to handover.",
  },
  {
    number: "03",
    title: "Business Analysis",
    description:
      "Process improvement and organisational effectiveness — we translate goals into clear, measurable, achievable solutions your teams can act on.",
  },
  {
    number: "04",
    title: "Data Management & Analytics",
    description:
      "Organisation, storage, security and analysis — turning raw data into decisions you can trust, with reporting and dashboards that drive action.",
  },
  {
    number: "05",
    title: "Training & Mentoring",
    description:
      "Brilliant, hands-on courses that build real, job-ready skills — empowering individuals and teams, with a special focus on women in tech.",
  },
];
