...
const CONTACT_METHODS = [
  {
    icon: Mail,
    label: "Email",
    value: "info@nnxit.co.za",
    href: "mailto:info@nnxit.co.za",
  },
  {
    icon: Phone,
    label: "Call",
    value: "+27 73 161 8176",
    href: "tel:+27731618176",
  },
  {
    icon: MessageCircle,
    label: "WhatsApp",
    value: "+27 73 161 8176",
    href: "https://wa.me/27731618176",
  },
  {
    icon: MapPin,
    label: "Visit",
    value: "Waterfall, Midrand, SA",
    href: "https://www.google.com/maps/search/?api=1&query=Waterfall+Midrand+South+Africa",
  },
];
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.15} y={20}>
        ...
        >
          Book a free consultation — pick whichever channel suits you
        </p>
      </FadeIn>
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          <span
            ...
            style={{ fontSize: "clamp(0.7rem, 1.1vw, 0.9rem)" }}
          >
            © 2026 NNX IT Consulting and Training
          </span>
          <span
            className="font-light uppercase tracking-widest text-[#D7E2EA]/50"
            style={{ fontSize: "clamp(0.7rem, 1.1vw, 0.9rem)" }}
          >
            Empowering women in tech · Midrand, SA
          </span>
        </div>
      </FadeIn>
    </section>
